...
**Note:** The Home tab (StudentHomeContent) already renders flashcard cards in the modern style (TiltedCard + Masonry + traffic lights). The My Flashcards tab renders the _same data type_ but in the completely old way. This visual inconsistency between tabs is the most jarring one.
