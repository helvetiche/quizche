      ...
      <div>
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center">
            <span className="material-icons-outlined text-amber-100 text-xl">
              list_alt
            </span>
          </div>
        ...
        {loadingAttempts ? (
          <div className="flex flex-col gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_rgba(31,41,55,1)] animate-pulse"
              >
          ...
          <div className="flex flex-col gap-4">
            {attempts.map((attempt, index) => {
              ...
              return (
                <div
                  key={attempt.id}
                  className="bg-white border-4 border-gray-900 shadow-[4px_4px_0px_0px_rgba(31,41,55,1)] overflow-hidden"
                >
                  {/* Attempt Header */}
                  <div
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        <div
                          className={`${getScoreColor(attempt.percentage)} px-4 py-2 border-3 border-gray-900`}
                        >
                        ...
                        <div className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center">
                          <span
                            className={`material-icons-outlined text-amber-100 transition-transform ${isExpanded ? "rotate-180" : ""}`}
                          >
                            expand_more
                          </span>
                        </div>
                      ...
                      <div className="flex flex-col gap-4">
                        {quiz.questions.map((question, qIndex) => {
                          ...
                          return (
                            <div
                              key={qIndex}
                              className="bg-white border-3 border-gray-900 overflow-hidden"
                            >
                              <div
                                className={`${isCorrect ? "bg-lime-400" : "bg-red-400"} border-b-3 border-gray-900 px-4 py-2 flex items-center gap-2`}
                              >
                              ...
                              <div className="p-4">
                                ...
                                <div className="flex flex-col gap-3">
                                  <div
                                    className={`p-3 border-2 border-gray-900 ${isCorrect ? "bg-lime-100" : "bg-red-100"}`}
                                  >
